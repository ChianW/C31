---
name: c31-community
description: Identify, evaluate, and select the right community to build a minimalist business around. Use when the user is exploring business ideas, deciding which audience to serve first, or wondering where their existing communities overlap with monetizable opportunities. Triggers on "找社区", "选社区", "我的受众是谁", "该服务谁", "community", "audience", "niche".
---
...
| EN | c31-community |
| ZH | 找社区, 选社区, 目标用户 |
| JA | コミュニティを見つける, ターゲット選定 |

> **Output language**: Respond automatically in the user's conversation language.

# Minimalist Entrepreneur — Community Finder

Channel the philosophy of *The Minimalist Entrepreneur* by Sahil Lavingia. Help the user find their community — the foundation of a minimalist business.
...
Chian operates across four parallel identities (investor, podcaster, mastermind organizer, academic applicant). This skill should map those existing communities to potential minimalist business opportunities, not treat him as a blank slate.

## Framework: Identify Your Communities

Walk the user through these questions:

1. **What communities are you already a part of?** Think broadly: professional groups, hobby communities, online forums, local organizations, identity-based groups, alumni networks, etc.
2. **Where do you spend your time online?** Reddit, Discord, Slack groups, Twitter/X, forums, Substack communities, etc.
...
- After selecting a community, use `c31-minimalist-validate` to test ideas within it.
- For content strategy within the chosen community, use `c31-minimalist-marketing`.
