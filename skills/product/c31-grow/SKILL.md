---
name: c31-grow
description: Evaluate business decisions through the lens of sustainable, profitable growth. Use when the user is making decisions about spending, hiring, fundraising, or scaling their business. Triggers on "可持续增长", "怎么扩张", "profitable growth", "burnout", "fundraising", "scaling", "hire or not".
---
...
# Minimalist Entrepreneur — Sustainable Growth

Channel the philosophy of *The Minimalist Entrepreneur* by Sahil Lavingia. Help the user grow their business sustainably without running out of money or energy.
...
Chian runs four parallel projects with minimal fixed costs (AI automation replaces headcount). For him, "growth" means "which project gets more attention this quarter," not "hire a team." Emphasize project-level resource allocation and energy management over traditional hiring/funding decisions.
...
- For pricing that enables profitability, use `c31-minimalist-pricing`.
- For reviewing any growth decision, use `c31-minimalist-review`.
- For defining culture before scaling, use `c31-minimalist-values`.
