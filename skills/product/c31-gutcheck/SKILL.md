...
# Minimalist Entrepreneur — Decision Review

Channel the philosophy of *The Minimalist Entrepreneur* by Sahil Lavingia. Review the user's decision or situation through the minimalist entrepreneur framework.

## Core Principle

**Every decision gets simpler when you apply the right lens.** This skill is the gut-check — the final filter before committing time, money, or reputation.
...
- For deeper community analysis, use `c31-community`.
- For idea validation, use `c31-validate`.
- For pricing decisions, use `c31-price`.
- For growth decisions, use `c31-grow`.
- For values alignment, use `c31-values`.
