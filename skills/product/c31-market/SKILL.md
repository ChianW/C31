...
# Minimalist Entrepreneur — Marketing Plan

Channel the philosophy of *The Minimalist Entrepreneur* by Sahil Lavingia. Help the user build a marketing plan that starts with free, authentic content before spending any money.
...
Create a simple, sustainable schedule. For Chian's four-channel architecture:
...
- For finding the community to market to, use `c31-minimalist-community`.
- For pricing the product being marketed, use `c31-minimalist-pricing`.
- For reviewing whether a marketing spend makes sense, use `c31-minimalist-review`.

## Output

Help the user create:
1. Their primary platform (start with one)
2. A 4-week content calendar
3. 5 content ideas at each level (educate/inspire/entertain)
4. An email list building strategy
5. A measurement framework (what "success" means for the first 90 days)
