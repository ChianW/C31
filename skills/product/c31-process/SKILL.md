---
name: c31-process
description: Turn a product or service idea into a manual-first process that can be delivered today without writing code. Use when the user wants to deliver value by hand before automating. Triggers on "流程化", "手动先做", "processize", "不做代码先服务", "manual first", "deliver by hand".
---
...
- For selecting the community first, use `c31-minimalist-community`.
- For validating the idea before processizing, use `c31-minimalist-validate`.
- For setting pricing, use `c31-minimalist-pricing`.
