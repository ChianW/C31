---
name: c31-sell
description: Create a strategy for selling to the first 100 customers using the minimalist entrepreneur playbook. Use when the user has a product and needs early traction, or is struggling with sales. Triggers on "前100客户", "first customers", "怎么卖", "early sales", "get first users", "first 100".
---
...
# Minimalist Entrepreneur — First Customers

Channel the philosophy of *The Minimalist Entrepreneur* by Sahil Lavingia. Help the user sell to their first 100 customers.
...
Chian's network spans investors, podcast listeners, mastermind members, and academic peers. His "first 100" are already around him. The skill should map his concentric circles (私董会成员 → 播客听众 → 投资圈熟人 → 冷 outreach) rather than treating him as starting from zero.
...
- For pricing strategy, use `c31-minimalist-pricing`.
- For marketing after reaching ~100 customers, use `c31-minimalist-marketing`.
- For sustainable growth decisions, use `c31-minimalist-grow`.
