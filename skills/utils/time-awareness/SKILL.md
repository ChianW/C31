---
name: time-awareness
description: today | now | current date | 今天 | 现在 — time-aware query execution policy
triggers: today,now,current date,current time,今天,现在,当前时间,当前日期,最近,过去,接下来
...
|----------|-----------------|
| EN | today,now,current date,current time,今天,现在,当前时间,当前日期,最近,过去,接下来 |
| ZH | 今天, 现在, 当前日期 |
| JA | 今日, 現在, 日付確認 |
